...
const dataEsp = {
  ...
  education: {
    ...
    data: [
      ...
      {
        title: '2020: Programa de Capacitación Informática Orientado a la Traducción',
        description: 'Curso en línea, AATI'
      },
      {
